...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
                ...
                .col
                  .row.justify-content-between.align-items-center
                    .col.mb-3.mb-sm-0
                      ...
                      p.text-small.mb-0 Formato de Diseño Instruccional para la creación de videos tipo spot animado.
                    .col-sm-auto
              ...
              .row.justify-content-around.align-items-center
                ...
                .col
                  .row.justify-content-between.align-items-center
                    .col.mb-3.mb-sm-0
                      h4.mb-1 Formato instruccional - Video
                      p.text-small.mb-0 Formato de Diseño Instruccional para la creación de videos tipo motion graphics.
                    .col-sm-auto
                      a.boton.color-acento-botones(href="https://docs.google.com/document/d/13JiM2kfIhjBIJj-l5IqxGvQHRqmNg5rRsr64vxJRuss/edit?usp=sharing" target="_blank")
                        span Descargar
                        i.fas.fa-file-download
    ...
    #t_4_3.titulo-segundo.color-acento-contenido
      h2 4.3 Video Clase / Video tutorial
                ...
                .col
                  .row.justify-content-between.align-items-center
                    .col.mb-3.mb-sm-0
                      ...
                      p.text-small.mb-0 Pautas para la creación de videos tipo videoclase.
                    .col-sm-auto
                      a.boton.color-acento-botones(href="https://docs.google.com/document/d/1Rsj62eoSHd8a4PaS4r_b_jv82vgKbiGmv-gO2rl-dhg/edit" target="_blank")
                        span Descargar
                        i.fas.fa-file-download


    #t_4_4.titulo-segundo.color-acento-contenido
      h2 4.4 Video Información del programa
                ...
                .col
                  .row.justify-content-between.align-items-center
                    .col.mb-3.mb-sm-0
                      ...
                      p.text-small.mb-0 Formato de Diseño Instruccional para la creación de videos de información del programa.
                    .col-sm-auto
                      a.boton.color-acento-botones(href="https://docs.google.com/document/d/15v4AkZoOz8xwvbN1C9Pj8_H1PcLt5Uh6hhbCE8Mcxw0/edit" target="_blank")
                        span Descargar
                        i.fas.fa-file-download
</template>
